module "aws_create_sp" {
  ...
  service_principal_name       = "mlopsStacksAWS1108v1-cicd"
  project_directory_path       = "/mlopsStacksAWS1108v1"
  service_principal_group_name = "mlopsStacksAWS1108v1-service-principals"
}
...
provider "databricks" {
  alias = "staging_sp"
  host  = "https://dbc-4827121d-c1f4.cloud.databricks.com"
